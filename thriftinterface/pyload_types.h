...
class DownloadInfo {
 public:
  ...
  DownloadInfo() : fid(0), name(""), speed(0), eta(0), format_eta(""), bleft(0), size(0), format_size(""), percent(0), statusmsg(""), format_wait(""), wait_until(0), packageID(0) {
  }
...
class FileData {
 public:
  ...
  FileData() : fid(0), url(""), name(""), plugin(""), size(0), format_size(""), statusmsg(""), packageID(0), error(""), order(0), progress(0) {
  }
...
class PackageData {
 public:
  ...
  PackageData() : pid(0), name(""), folder(""), site(""), password(""), order(0), priority(0) {
  }
...
class PackageInfo {
 public:
  ...
  PackageInfo() : pid(0), name(""), folder(""), site(""), password(""), order(0), priority(0) {
  }
