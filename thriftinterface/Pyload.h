...
class PyloadIf {
 public:
  ...
  virtual void getConfig(std::vector<ConfigSection> & _return) = 0;
  virtual void getPluginConfig(std::vector<ConfigSection> & _return) = 0;
  ...
  virtual void checkURL(std::map<std::string, std::string> & _return, const LinkList& urls) = 0;
  ...
  virtual void getQueue(std::vector<PackageInfo> & _return) = 0;
  virtual void getCollector(std::vector<PackageInfo> & _return) = 0;
  ...
  virtual void setPriority(const PackageID pid, const Priority priority) = 0;
  ...
  virtual void updateAccounts(const AccountData& data) = 0;
  virtual void removeAccount(const std::string& plugin, const std::string& account) = 0;
  virtual bool login(const std::string& username, const std::string& password) = 0;
  virtual void getUserData(UserData& _return) = 0;
  virtual void getServices(std::map<std::string, ServiceInfo> & _return) = 0;
  virtual bool hasService(const std::string& plugin, const std::string& func) = 0;
...
class PyloadNull : virtual public PyloadIf {
 public:
  ...
  void getConfig(std::vector<ConfigSection> & /* _return */) {
    return;
  }
  void getPluginConfig(std::vector<ConfigSection> & /* _return */) {
    return;
  }
  void pauseServer() {
    return;
  ...
  void checkURL(std::map<std::string, std::string> & /* _return */, const LinkList& /* urls */) {
    return;
  }
  bool isTimeDownload() {
    bool _return = false;
  ...
  void getQueue(std::vector<PackageInfo> & /* _return */) {
    return;
  }
  void getCollector(std::vector<PackageInfo> & /* _return */) {
    return;
  }
  ...
  void setPriority(const PackageID /* pid */, const Priority /* priority */) {
    return;
  }
  ...
  void updateAccounts(const AccountData& /* data */) {
    return;
  }
  void removeAccount(const std::string& /* plugin */, const std::string& /* account */) {
    return;
  }
  ...
  void getUserData(UserData& /* _return */) {
    return;
  }
  void getServices(std::map<std::string, ServiceInfo> & /* _return */) {
    return;
  }
  bool hasService(const std::string& /* plugin */, const std::string& /* func */) {
    bool _return = false;
    return _return;
  }
...
class Pyload_getConfig_result {
 public:
  ...
  std::vector<ConfigSection>  success;
...
typedef struct _Pyload_checkURL_args__isset {
  _Pyload_checkURL_args__isset() : urls(false) {}
  bool urls;
} _Pyload_checkURL_args__isset;

class Pyload_checkURL_args {
 public:

  Pyload_checkURL_args() {
  }

  virtual ~Pyload_checkURL_args() throw() {}

  LinkList urls;

  _Pyload_checkURL_args__isset __isset;

  bool operator == (const Pyload_checkURL_args & rhs) const
  {
    if (!(urls == rhs.urls))
      return false;
    return true;
  ...
  bool operator < (const Pyload_checkURL_args & ) const;
...
class Pyload_checkURL_pargs {
 public:


  virtual ~Pyload_checkURL_pargs() throw() {}
...
typedef struct _Pyload_checkURL_result__isset {
  _Pyload_checkURL_result__isset() : success(false) {}
  bool success;
} _Pyload_checkURL_result__isset;

class Pyload_checkURL_result {
 public:

  Pyload_checkURL_result() {
  }

  virtual ~Pyload_checkURL_result() throw() {}

  std::map<std::string, std::string>  success;

  _Pyload_checkURL_result__isset __isset;

  bool operator == (const Pyload_checkURL_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const Pyload_checkURL_result & ) const;
...
typedef struct _Pyload_checkURL_presult__isset {
  _Pyload_checkURL_presult__isset() : success(false) {}
  bool success;
} _Pyload_checkURL_presult__isset;

class Pyload_checkURL_presult {
 public:


  virtual ~Pyload_checkURL_presult() throw() {}

  std::map<std::string, std::string> * success;

  _Pyload_checkURL_presult__isset __isset;
...
class Pyload_getQueue_result {
 public:
  ...
  std::vector<PackageInfo>  success;
...
typedef struct _Pyload_setPriority_args__isset {
  _Pyload_setPriority_args__isset() : pid(false), priority(false) {}
  bool pid;
  bool priority;
} _Pyload_setPriority_args__isset;

class Pyload_setPriority_args {
 public:

  Pyload_setPriority_args() : pid(0), priority(0) {
  }

  virtual ~Pyload_setPriority_args() throw() {}

  PackageID pid;
  Priority priority;

  _Pyload_setPriority_args__isset __isset;

  bool operator == (const Pyload_setPriority_args & rhs) const
  {
    if (!(pid == rhs.pid))
      return false;
  ...
  bool operator < (const Pyload_setPriority_args & ) const;
...
class Pyload_setPriority_pargs {
 public:


  virtual ~Pyload_setPriority_pargs() throw() {}
...
class Pyload_setPriority_result {
 public:
  ...
  Pyload_setPriority_result() {
  }

  virtual ~Pyload_setPriority_result() throw() {}


  bool operator == (const Pyload_setPriority_result & /* rhs */) const
  {
    return true;
  }
  bool operator != (const Pyload_setPriority_result &rhs) const {
  ...
  bool operator < (const Pyload_setPriority_result & ) const;
...
class Pyload_setPriority_presult {
 public:


  virtual ~Pyload_setPriority_presult() throw() {}
...
typedef struct _Pyload_updateAccounts_args__isset {
  _Pyload_updateAccounts_args__isset() : data(false) {}
  bool data;
} _Pyload_updateAccounts_args__isset;

class Pyload_updateAccounts_args {
 public:

  Pyload_updateAccounts_args() {
  }

  virtual ~Pyload_updateAccounts_args() throw() {}

  AccountData data;

  _Pyload_updateAccounts_args__isset __isset;

  bool operator == (const Pyload_updateAccounts_args & rhs) const
  {
    if (!(data == rhs.data))
      return false;
    return true;
  ...
  bool operator < (const Pyload_updateAccounts_args & ) const;
...
class Pyload_updateAccounts_pargs {
 public:


  virtual ~Pyload_updateAccounts_pargs() throw() {}
...
class Pyload_updateAccounts_result {
 public:
  ...
  Pyload_updateAccounts_result() {
  }

  virtual ~Pyload_updateAccounts_result() throw() {}


  bool operator == (const Pyload_updateAccounts_result & /* rhs */) const
  {
    return true;
  }
  bool operator != (const Pyload_updateAccounts_result &rhs) const {
  ...
  bool operator < (const Pyload_updateAccounts_result & ) const;
...
class Pyload_updateAccounts_presult {
 public:


  virtual ~Pyload_updateAccounts_presult() throw() {}
...
class Pyload_getServices_result {
 public:
  ...
  std::map<std::string, ServiceInfo>  success;
...
class PyloadClient : virtual public PyloadIf {
 public:
  ...
  void getConfig(std::vector<ConfigSection> & _return);
  void send_getConfig();
  void recv_getConfig(std::vector<ConfigSection> & _return);
  void getPluginConfig(std::vector<ConfigSection> & _return);
  void send_getPluginConfig();
  void recv_getPluginConfig(std::vector<ConfigSection> & _return);
  void pauseServer();
  ...
  void checkURL(std::map<std::string, std::string> & _return, const LinkList& urls);
  void send_checkURL(const LinkList& urls);
  void recv_checkURL(std::map<std::string, std::string> & _return);
  bool isTimeDownload();
  ...
  void getQueue(std::vector<PackageInfo> & _return);
  void send_getQueue();
  void recv_getQueue(std::vector<PackageInfo> & _return);
  void getCollector(std::vector<PackageInfo> & _return);
  void send_getCollector();
  void recv_getCollector(std::vector<PackageInfo> & _return);
  void getQueueData(std::vector<PackageData> & _return);
  ...
  void setPriority(const PackageID pid, const Priority priority);
  void send_setPriority(const PackageID pid, const Priority priority);
  ...
  void updateAccounts(const AccountData& data);
  void send_updateAccounts(const AccountData& data);
  void recv_updateAccounts();
  void removeAccount(const std::string& plugin, const std::string& account);
  void send_removeAccount(const std::string& plugin, const std::string& account);
  void recv_removeAccount();
  bool login(const std::string& username, const std::string& password);
  void send_login(const std::string& username, const std::string& password);
  bool recv_login();
  void getUserData(UserData& _return);
  void send_getUserData();
  void recv_getUserData(UserData& _return);
  void getServices(std::map<std::string, ServiceInfo> & _return);
  void send_getServices();
  void recv_getServices(std::map<std::string, ServiceInfo> & _return);
  bool hasService(const std::string& plugin, const std::string& func);
  void send_hasService(const std::string& plugin, const std::string& func);
...
class PyloadProcessor : virtual public ::apache::thrift::TProcessor {
 protected:
  boost::shared_ptr<PyloadIf> iface_;
  virtual bool process_fn(::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, std::string& fname, int32_t seqid);
 private:
  std::map<std::string, void (PyloadProcessor::*)(int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*)> processMap_;
  void process_getConfigValue(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_setConfigValue(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getConfig(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getPluginConfig(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_pauseServer(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_unpauseServer(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_togglePause(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_statusServer(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_freeSpace(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getServerVersion(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_kill(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_restart(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getLog(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_checkURL(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_isTimeDownload(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_isTimeReconnect(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_toggleReconnect(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_statusDownloads(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_addPackage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getPackageData(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getFileData(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_deleteFiles(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_deletePackages(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getQueue(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getCollector(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getQueueData(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getCollectorData(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_addFiles(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_pushToQueue(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_pullFromQueue(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_restartPackage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_restartFile(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_recheckPackage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_stopAllDownloads(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_stopDownloads(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_setPackageName(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_movePackage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_uploadContainer(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_setPriority(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_orderPackage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_orderFile(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_setPackageData(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_deleteFinished(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_restartFailed(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getPackageOrder(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getFileOrder(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_isCaptchaWaiting(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getCaptchaTask(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getCaptchaTaskStatus(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_setCaptchaResult(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getEvents(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getAccounts(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getAccountTypes(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_updateAccounts(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_removeAccount(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_login(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getUserData(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getServices(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_hasService(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_call(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
 public:
  PyloadProcessor(boost::shared_ptr<PyloadIf> iface) :
    ...
    processMap_["checkURL"] = &PyloadProcessor::process_checkURL;
    ...
    processMap_["setPriority"] = &PyloadProcessor::process_setPriority;
    ...
    processMap_["updateAccounts"] = &PyloadProcessor::process_updateAccounts;
...
class PyloadMultiface : virtual public PyloadIf {
 ...
 public:
  ...
  void checkURL(std::map<std::string, std::string> & _return, const LinkList& urls) {
    ...
    for (uint32_t i = 0; i < sz; ++i) {
      if (i == sz - 1) {
        ifaces_[i]->checkURL(_return, urls);
        return;
      } else {
        ifaces_[i]->checkURL(_return, urls);
      }
  ...
  void setPriority(const PackageID pid, const Priority priority) {
    uint32_t sz = ifaces_.size();
    for (uint32_t i = 0; i < sz; ++i) {
      ifaces_[i]->setPriority(pid, priority);
    }
  }
