...
class Pyload_getConfig_result {
 public:
  ...
  void __set_success(const std::vector<ConfigSection> & val) {
    success = val;
  }
...
class Pyload_addPackage_args {
 public:
  ...
  Pyload_addPackage_args() : name(""), dest((Destination::type)0) {
  }
...
class Pyload_getQueue_result {
 public:
  ...
  void __set_success(const std::vector<PackageInfo> & val) {
    success = val;
  }
...
class Pyload_movePackage_args {
 public:
  ...
  Pyload_movePackage_args() : destination((Destination::type)0), pid(0) {
  }
...
class Pyload_getPackageOrder_args {
 public:
  ...
  Pyload_getPackageOrder_args() : destination((Destination::type)0) {
  }
...
class Pyload_updateAccounts_args {
 public:
  ...
  void __set_data(const AccountData& val) {
    data = val;
  }
...
class Pyload_getServices_result {
 public:
  ...
  void __set_success(const std::map<std::string, ServiceInfo> & val) {
    success = val;
  }
...
class PyloadProcessor : public ::apache::thrift::TProcessor {
 ...
 private:
  ...
  void process_updateAccounts(int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot, void* callContext);
